...
melody = {	
	...
	\tempo \markup \sans \bold "Allegreto"
	
	\repeat volta 2
	{
		g'4-3 g'4.. fis'16-2 e'4..-0 d'16-4 |
		e'4-0 e'4.. d'16-3 \barre "II" { e'4..-4 fis'16-1 } |
	...
	\alternative
	{
		...
		{
			c''4 c''4.. a'16 d''4.. h'16 |
			g'4 g'4.. a'16 h'4.. g'16 |
		}
	}

	e'4 e'4.. g'16 fis'4.. d'16 |
	<< { \voiceOne <e' h g>2.~ q2 |\coda q2.~ q2 | } \\ { \voiceFour <e,>2.~ q2 | q2.~ q2 | } >>
	<e' h g>2.~ q2 |
	\time 3/4 q4. r8 e'4 \bar "||"

	\tempo \markup \sans \bold "Moderato" \time 4/4
	g'2.( fis'4 |
	d') e'( g' fis') |
	d'2.( c'4) |
	h2( h4 a) |
	...
	h1~ |
	h4 d' d' c' |
	e' e' e' fis'_\markup\italic{"Da Capo al" \raise #.5 \tiny\musicglyph #"scripts.coda"} \bar "||" 
...
basses = {
	...
	{
		{
			h,4 h,4.. h,16 h,4.. h,16 |
			h,4 h,4.. h,16 h,4.. h,16 |
			h,4 h,4.. h,16 <c' g h,>2 |
	...
	% Coda
	c4\rest d4.. d16 d4.. d16 |
	c4\rest cis4.. cis16 cis4.. cis16 |
	c'4 c'4.. h16 c'4.. h16 |
	c'4 c'4.. h16 c'4.. h16 |
	c4\rest h,4.. h,16 h,4.. h,16 |
	c4\rest h,4.. h,16 h,4.. h,16 |
...
#(set! paper-alist (cons '("ribbon" . (cons (* 200 cm) (* 4 cm))) paper-alist))
