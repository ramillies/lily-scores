...
\usepackage{pbox}
\usepackage{pdfpages}
\setmainfont[Ligatures=TeX,ItalicFont={EBGaramond08-Italic.ttf},SmallCapsFont={EBGaramond08-SC.ttf},BoldFont={LinLibertine_RB.otf}]{EBGaramond08-Regular.ttf}
...
\includepdf{alcaniz.pdf}

\includepdf{alcazar-de-segovia.pdf}

\includepdf{calatrava.pdf}

\includepdf{javier.pdf}

\includepdf{olite.pdf}

\includepdf{redaba.pdf}

\includepdf{turegano.pdf}

\includepdfmerge[nup=1x2,angle=-90]{alba-de-tormes.pdf,manzanares-del-real.pdf,siguenza.pdf,torrija.pdf,montemayor.pdf,simancas-small.pdf}

\includepdf{zafra.pdf}
\end{document}
