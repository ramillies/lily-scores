...
%   (list
%    `(nl-octaves . ,(append (assoc-get 'deutsch language-pitch-names #f)
%       `(
...
%         
%         (Heses . ,(ly:make-pitch -1 6 -7/8))
%         (Hes . ,(ly:make-pitch -1 6 -3/8))
%         (B . ,(ly:make-pitch -1 6 -3/8))
%         (H . ,(ly:make-pitch -1 6 1/8))
%         (His . ,(ly:make-pitch -1 6 5/8))
%         (Hisis . ,(ly:make-pitch -1 6 9/8))
%       
%         )))))
%
